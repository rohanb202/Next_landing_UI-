  ...
  return (
    <section ref={sec} className='h-screen'>
        <div className='flex flex-col items-center justify-center h-full space-y-3'>
            <h1 className='font-semibold text-md md:text-lg'>We take privacy seriously</h1>
            <h1 className='text-3xl font-bold md:text-4xl'>Before you get started</h1>
            <p className='text-xl text-center md:text-2xl'>"We won't share your answers with anyone and won't ever tell <br/>
